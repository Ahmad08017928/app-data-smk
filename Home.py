...
with st.sidebar: 
    ...
    option = st.sidebar.selectbox('Silahkan pilih :', ('Home', 'Viusalisasi Data 1', 'Tes klassifikasi', 'klassifikasi'))   
    orientation = "horizontal"
    icons = ('house', 'book', 'envelope', 'list')

#data frame
if option == 'Home' or option == '' :
    st.title('Kelebihan Peserta Didik')
    st.write(" SMK NEGERI 1 KRAKSAAN")
...
elif option =='Viusalisasi Data 1':
    st.title("Visualisai Data")
    st.write("Visualisasi data Jumlah orang tua yang mengetahui kelebihan seorang anak")
    st.write("Di Smk Negeri 1 Kraksaan")
    # url = ("https://raw.githubusercontent.com/Ahmad08017928/dataset-smkn1/main/data.csv")
    df = pd.read_csv("dataset\data.csv")
    #Mengisi data yang kosong dengan nilai yang sebelumnya
    df1 = df.drop(['Timestamp', '14. Orangtua saya menunjukkan bagaimana menggunakan kelebihan saya pada berbagai situasi yang berbeda.'], axis='columns')
    ...
    st.write("Visualisai Data di bawah ini untuk mengetahui seberapa banyak orang tua yang menyadari kelebihan seorang anak")
    ...
    plt.show()
    st.pyplot(fig1)
    st.write("Dari digram tersebut menunjukan bahwa sebagian besar orang tua yang menyadari kelebihan pada setiap anak dengan responden 61.9% memilih kategori Sesuai, sementara kategori tidak sesuai hanya mencakup 7.9% dari total keseluruhan")
    
    st.write("Di bawah ini adalah visualisasi data untuk orang tua yang tidak mengetahui kelebihan seorang anak")
    ...
    st.pyplot(fig2)
    st.write("Dari data yang ada, terlihat bahwa sebagian orang tua. 58.7% tidak mengetahui kelebihan yang di miliki oleh anak anak mereka")
    ...
    if st.button('Prediksi'):
        ...
        if hasil_knn == 0:
            st.write("Orang tua {} sangat mengetahui kemampuan {}".format(Nama, Nama))
        elif hasil_knn == 2:
            st.write("Orang tua {} mengetahui kemampuan {}".format(Nama, Nama))
        elif hasil_knn == 3 :
            st.write("Orang tua {} tidak mengetahui kemampuan {}".format(Nama, Nama))
        elif hasil_knn == 1 :
            st.write("Orang tua {} sangat tidak mengetahui kemampuan {}".format(Nama, Nama))
